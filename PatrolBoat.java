//Ibrahim Ouarrach
// this is the PatrolBoat class which extand the ship class but with getters and setters methods and the size is of the ship is 2.
// also here where we store the cordination of the ship, which we used if its a sink or not.

public class PatrolBoat extends Ship{
    private int[] cordinationRowsForVertical = new int[3];
    private int[] cordinationColsForHorizontal = new int[3];
